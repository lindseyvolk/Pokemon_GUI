...
public class Catch extends AppCompatActivity {
    ...
    public void openActivity1() {
        Intent i = new Intent(getApplicationContext(), MudKipClass.class);
        startActivity(i);
    }


    public void openActivity2() {
        Intent intent = new Intent(this, AbraClass.class);
        startActivity(intent);

    }

    public void openActivity3() {
        Intent intent = new Intent(this, EeveeClass.class);
        startActivity(intent);
    }

    public void openActivity4() {
        Intent intent = new Intent(this, SnorlaxClass.class);
        startActivity(intent);
    }

    public void openActivity5() {
        Intent intent = new Intent(this, DratiniClass.class);
        startActivity(intent);
    }

    public void openActivity6() {
        Intent intent = new Intent(this, OnixClass.class);
        startActivity(intent);
    }
